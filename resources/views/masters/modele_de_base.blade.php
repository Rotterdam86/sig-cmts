...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            body {
                font-family: 'Roboto', 'Open sans', 'Nunito', Arial, Helvetica, sans-serif;
            }
    ...
    <body class="antialiased">
        <!-- insertion de la bar de menu -->
        @include('masters/partials/_nav')

        <!-- placement du contenu -->
        @yield('content')
        
        <!-- insertion du pied de page -->
        @include('masters/partials/_footer')
